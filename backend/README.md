...
## Project Structure
    ...
    ├── testapiautosetting_125101  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125101`
...
2. Clone this repo and `cd testapiautosetting_125101`
